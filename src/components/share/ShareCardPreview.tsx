...
const styles = StyleSheet.create({
  ...
  score: { color: colors.text, fontSize: 30, fontWeight: '900' },
  verdict: { color: colors.dangerRed, fontSize: 27, fontWeight: '900' },
  rule: { height: 1, backgroundColor: colors.border, marginVertical: 4 },
  label: { color: colors.muted, fontSize: 10, fontWeight: '900' },
  body: { color: colors.text, fontSize: 13, fontWeight: '800' },
